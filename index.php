...
<head>
    ...
    <title>فيسبوك - سجل الدخول أو سجل</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Helvetica, Arial, sans-serif; }
        ...
        .right form input { width: 100%; padding: 14px 16px; border: 1px solid #dddfe2; border-radius: 6px; font-size: 17px; margin-bottom: 12px; outline: none; box-sizing: border-box; }
        .right form input:focus { border-color: #1877f2; box-shadow: 0 0 0 2px #e7f3ff; }
        .right form button { width: 100%; padding: 12px; background: #1877f2; color: #fff; font-size: 20px; font-weight: bold; border: none; border-radius: 6px; cursor: pointer; }
        .right form button:hover { background: #166fe5; }
        ...
        .right .signup-btn { width: auto; margin: 0 auto; display: block; padding: 12px 16px; background: #42b72a; color: #fff; font-size: 17px; font-weight: bold; border: none; border-radius: 6px; cursor: pointer; }
        .right .signup-btn:hover { background: #36a420; }

        /* ===== رسالة الخطأ (جوه الصفحة) ===== */
        .error-message {
            background: #ffebee;
        ...
        .error-message a:hover { color: #b71c1c; }
...
<body>
    <div class="container">
        ...
        <div class="right">
            <!-- رسالة الخطأ تظهر هنا لو في خطأ -->
